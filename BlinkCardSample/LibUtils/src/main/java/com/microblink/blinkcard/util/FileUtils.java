...
public class FileUtils {
    ...
    public static byte[] loadBytesFromFileUri(Uri fileUri, Context context) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(context, com.microblink.blinkcard.libutils.R.string.toast_error_open_file, Toast.LENGTH_SHORT).show();
        } catch (IOException e) {
            e.printStackTrace();
            Toast.makeText(context, com.microblink.blinkcard.libutils.R.string.toast_error_read_file, Toast.LENGTH_SHORT).show();
        } finally {
            try {
                fileStream.close();
            } catch (IOException e) {
