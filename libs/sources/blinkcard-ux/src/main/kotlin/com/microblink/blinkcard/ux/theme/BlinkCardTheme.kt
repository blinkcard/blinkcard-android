...
fun BlinkCardSdkTheme(
    ...
    CompositionLocalProvider(
        ...
        LocalBaseBlinkCardSdkStrings provides (uiSettings.sdkStrings as? BlinkCardSdkStrings
            ?: BlinkCardTheme.sdkStrings),
        ...
        MaterialTheme(
            colorScheme = uiSettings.colorScheme ?: BlinkCardTheme.sdkTheme,
            content = content
        )
    }
}

internal object BlinkCardTheme {
    val uiColors: UiColors
        @Composable
        get() = LocalBaseUiColors.current

    val sdkStrings: BlinkCardSdkStrings
        @Composable
        get() = LocalBaseBlinkCardSdkStrings.current
