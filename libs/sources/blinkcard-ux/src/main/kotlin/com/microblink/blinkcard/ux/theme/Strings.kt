...
import com.microblink.blinkcard.ux.theme.SdkStrings.Companion.Default
 ...
 * created and used in [com.microblink.blinkcard.ux.UiSettings.sdkStrings].
 *
...
/**
 * @see com.microblink.blinkcard.ux.theme.SdkStrings
 */
@Immutable
@Parcelize
...
data class AccessibilityStrings(
    ...
    companion object {
        @JvmStatic val Default: AccessibilityStrings = AccessibilityStrings(
            scanCompleted = R.string.mb_blinkcard_accessibility_success_document_scanned,
            firstSideScanned = R.string.mb_blinkcard_accessibility_success_first_side_scanned,
            previousPage = R.string.mb_blinkcard_accessibility_previous_page,
            nextPage = R.string.mb_blinkcard_accessibility_next_page,
            showHelpScreens = R.string.mb_blinkcard_accessibility_show_help_screens,
            turnFlashlightOff = R.string.mb_blinkcard_accessibility_turn_flashlight_off,
            turnFlashlightOn = R.string.mb_blinkcard_accessibility_turn_flashlight_on,
            exitScanning = R.string.mb_blinkcard_accessibility_exit_scanning,
            flashlightOff = R.string.mb_blinkcard_accessibility_flashlight_off,
            flashlightOn = R.string.mb_blinkcard_accessibility_flashlight_on
        )
    }
}
