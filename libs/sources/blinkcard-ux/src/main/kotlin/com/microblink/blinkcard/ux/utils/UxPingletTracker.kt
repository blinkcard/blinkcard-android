...
import com.microblink.blinkcard.core.ping.pinglets.CameraHardwareInfo
import com.microblink.blinkcard.core.ping.pinglets.CameraInputInfo
import com.microblink.blinkcard.core.ping.pinglets.CameraPermission
import com.microblink.blinkcard.core.ping.pinglets.ScanningConditions
import com.microblink.blinkcard.core.ping.pinglets.UxEvent
import com.microblink.blinkcard.core.ping.util.PingletTracker
import com.microblink.blinkcard.ux.camera.CameraDevicesDetails
import com.microblink.blinkcard.ux.camera.CameraInputDetails
import com.microblink.blinkcard.ux.camera.CameraLensFacing
import com.microblink.blinkcard.ux.camera.FocusType
...
object UxPingletTracker: PingletTracker() {
    ...
    object CameraInfo {
        /**
         * Tracks information about the camera input configuration used for card scanning.
     ...
     * that occur during the card scanning process.
     */
    object UxEvent {
        /**
        ...
        fun trackSimpleEvent(type: SimpleUxEventType, sessionNumber: Int) {
            trackUxPingletIfHaveSessionNumber(
                uxEventPinglet = UxEvent(
                    eventType = when (type) {
                        SimpleUxEventType.CameraStarted -> com.microblink.blinkcard.core.ping.pinglets.UxEvent.EventType.CAMERASTARTED
                        SimpleUxEventType.CameraClosed -> com.microblink.blinkcard.core.ping.pinglets.UxEvent.EventType.CAMERACLOSED
                        SimpleUxEventType.OnboardingInfoDisplayed -> com.microblink.blinkcard.core.ping.pinglets.UxEvent.EventType.ONBOARDINGINFODISPLAYED
                        SimpleUxEventType.CloseButtonClicked -> com.microblink.blinkcard.core.ping.pinglets.UxEvent.EventType.CLOSEBUTTONCLICKED
         ...
         * @param sessionNumber The session identifier for associating this event with a specific scanning session
         */
        fun trackErrorMessageEvent(errorMessageType: com.microblink.blinkcard.core.ping.pinglets.UxEvent.ErrorMessageType, sessionNumber: Int) {
            trackUxPingletIfHaveSessionNumber(
                uxEventPinglet = UxEvent(
                    eventType = com.microblink.blinkcard.core.ping.pinglets.UxEvent.EventType.ERRORMESSAGE,
         ...
         * @param sessionNumber The session identifier for associating this event with a specific scanning session
         */
        fun trackAlertDisplayedEvent(alertType: com.microblink.blinkcard.core.ping.pinglets.UxEvent.AlertType, sessionNumber: Int) {
            trackUxPingletIfHaveSessionNumber(
                uxEventPinglet = UxEvent(
                    eventType = com.microblink.blinkcard.core.ping.pinglets.UxEvent.EventType.ALERTDISPLAYED,
                    alertType = alertType
                ),
                sessionNumber = sessionNumber
            )
         ...
         * @param sessionNumber The session identifier for associating this event with a specific scanning session
         */
        fun trackHelpCloseEvent(helpCloseType: com.microblink.blinkcard.core.ping.pinglets.UxEvent.HelpCloseType, sessionNumber: Int) {
            trackUxPingletIfHaveSessionNumber(
                uxEventPinglet = UxEvent(
                    eventType = com.microblink.blinkcard.core.ping.pinglets.UxEvent.EventType.HELPCLOSED,
         ...
         */
        private fun trackUxPingletIfHaveSessionNumber(uxEventPinglet: com.microblink.blinkcard.core.ping.pinglets.UxEvent, sessionNumber: Int) {
            if (sessionNumber > 0) {
    ...
    object ScanningConditions {
        ...
        fun trackTorchStateUpdate(torchOn: Boolean, sessionNumber: Int) {
            val scanningConditionsPinglet = ScanningConditions(
                updateType = com.microblink.blinkcard.core.ping.pinglets.ScanningConditions.UpdateType.FLASHLIGHTSTATE,
        ...
        fun trackScreenOrientationChange(
            ...
            val scanningConditionsPinglet = ScanningConditions(
                updateType = com.microblink.blinkcard.core.ping.pinglets.ScanningConditions.UpdateType.DEVICEORIENTATION,
                deviceOrientation = when(screenOrientation) {
                    ScreenOrientation.LandscapeLeft ->
                        com.microblink.blinkcard.core.ping.pinglets.ScanningConditions.DeviceOrientation.LANDSCAPELEFT
                    ScreenOrientation.LandscapeRight ->
                        com.microblink.blinkcard.core.ping.pinglets.ScanningConditions.DeviceOrientation.LANDSCAPERIGHT
                    ScreenOrientation.ReversePortrait ->
                        com.microblink.blinkcard.core.ping.pinglets.ScanningConditions.DeviceOrientation.PORTRAITUPSIDE
                    else ->
                        com.microblink.blinkcard.core.ping.pinglets.ScanningConditions.DeviceOrientation.PORTRAIT
                }
            )
            addPingletToQueueIfManagerExists(scanningConditionsPinglet, sessionNumber)
        }
    ...
    object CameraPermission {
        ...
        fun trackCameraPermissionCheck(sessionNumber: Int) {
            addPingletToQueueIfManagerExists(
                pinglet = CameraPermission(
                    eventType = com.microblink.blinkcard.core.ping.pinglets.CameraPermission.EventType.CAMERAPERMISSIONCHECK
                ),
                sessionNumber = sessionNumber
            )
        }
        ...
        fun trackCameraPermissionRequest(sessionNumber: Int) {
            addPingletToQueueIfManagerExists(
                pinglet = CameraPermission(
                    eventType = com.microblink.blinkcard.core.ping.pinglets.CameraPermission.EventType.CAMERAPERMISSIONREQUEST
                ),
                sessionNumber = sessionNumber
            )
        }
        ...
        fun trackCameraPermissionUserResponse(cameraPermissionGranted: Boolean, sessionNumber: Int) {
            addPingletToQueueIfManagerExists(
                pinglet = CameraPermission(
                    eventType = com.microblink.blinkcard.core.ping.pinglets.CameraPermission.EventType.CAMERAPERMISSIONUSERRESPONSE,
