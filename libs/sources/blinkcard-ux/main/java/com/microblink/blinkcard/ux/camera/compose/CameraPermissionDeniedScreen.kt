...
package com.microblink.blinkcard.ux.camera.compose
...
import com.microblink.blinkcard.ux.theme.Cobalt
...
fun CameraPermissionDeniedScreen(requestCameraPermission: () -> Unit) {
    ...
    Box(
        ...
        Column(
            ...
            Image(
                painter = painterResource(id = R.drawable.mb_blinkcard_camera_denied),
            ...
            Text(
                ...
                text = stringResource(id = R.string.mb_blinkcard_camera_permission_required),
                color = Black,
                fontSize = 20.sp,
            ...
            Button(
                ...
                Text(text = stringResource(id = R.string.mb_blinkcard_enable_camera), color = White)
            }
        }
        ...
        if (shouldShowDialog.value) {
            AlertDialog(
                ...
                title = {
                    Text(
                        text = stringResource(R.string.mb_blinkcard_warning),
                        color = Black
                    )
                },
                text = {
                    Text(
                        text = stringResource(R.string.mb_blinkcard_enable_permission_help),
                        color = Black
                    )
                },
                ...
                confirmButton = {
                    Button(
                        ...
                        Text(
                            text = stringResource(R.string.mb_blinkcard_ok),
                            color = White
                        )
                    }
                }
